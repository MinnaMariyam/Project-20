...
function bullet2(){
background("white");
bullet = createSprite(150,460);
bullet.addImage(bulletImage);
bullet.scale = 0.2;
bullet.x = 250;

if(girl.isTouching(bullet2Group)){


  
  boyGroup.setVelocityXEach(8);
...
bullet2Group.add(bullet);
bullet2Group.add(blood);
